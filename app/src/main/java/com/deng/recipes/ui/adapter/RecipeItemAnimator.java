...
public class RecipeItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == RecipeItemAdapter.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((RecipeItemAdapter.CellFeedViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final RecipeItemAdapter.CellFeedViewHolder holder) {
    ...
    private void dispatchChangeFinishedIfAllAnimationsEnded(RecipeItemAdapter.CellFeedViewHolder holder) {
    ...
    private void resetLikeAnimationState(RecipeItemAdapter.CellFeedViewHolder holder) {
